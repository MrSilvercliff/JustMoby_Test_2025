...
namespace ZerglingUnityPlugins.UI.Scripts.Pools
{
    ...
    public class ZenjectFactoryMonoPool<T> : IZenjectFactoryMonoPool<T> where T : Component
    {
        ...
        public ZenjectFactoryMonoPool(T source, IFactory<T, T> factory, Transform parent = null)
        {
