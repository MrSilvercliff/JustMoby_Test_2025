...
namespace _Project.Scripts.Project.Services.UI.Panels
{
    public class PanelController : PanelControllerBase
    {
        ...
        private async Task InitPanelsList(Dictionary<Type, IPanelWindow> dictionary, IReadOnlyCollection<PanelWindow> list)
        {
            ...
            {
                var panelGO = diContainer.InstantiatePrefab(panel, _panelsContainer);
                var component = panelGO.GetComponent<IPanelWindow>();
