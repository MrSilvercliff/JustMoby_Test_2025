...
{
    public interface IBalanceService : IProjectService
    { 
    }

    public abstract class BalanceService : IBalanceService
    {
        ...
        private async Task<bool> InitStorage(IProjectService balanceStorage)
        {
        ...
        protected abstract HashSet<IProjectService> GetStoragesToInit();
    }
}